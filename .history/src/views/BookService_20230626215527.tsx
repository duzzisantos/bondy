      ...
      <div className="text-start py-4">
        ...
        <>
          <BookingForm
            ...
            setWishlistOne={changeOne("Ijeoma")}
            setWishListTwo={changeTwo("Kalu")}
            setWishListThree={changeThree("Biara")}
            setWishListFour={changeFour("Ntupio")}
            setWishListFive={changeFive("Echi")}
            setWishListSix={changeSix("Odikwa")}
