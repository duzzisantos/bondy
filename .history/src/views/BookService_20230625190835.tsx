    ...
    <div className="col-10 px-5 pt-5 py-5 ms-auto vh-100 vstack gap-2 d-flex flex-column custom-color">
      ...
      <div className="text-start mb-5">
        ...
        <div className="hstack gap-4 mt-4 py-4 d-flex flex-row flex-wrap">
          <div
            className="col-sm-3 px-3 chosen-services shadow-sm text-center"
            id="drop-target1"
            onDrop={handleDrop}
            onDragOver={handleDragOver}
          >
          ...
          <div
            className="col-lg-3 px-3 chosen-services shadow-sm text-center"
            id="drop-target3"
            onDrop={handleDrop}
            onDragOver={handleDragOver}
          >
          ...
          <div
            className="px-3 col-sm-3 chosen-services shadow-sm text-center"
            id="drop-target4"
            onDrop={handleDrop}
            onDragOver={handleDragOver}
          >
