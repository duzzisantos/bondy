...
const LandingPageScrollContainer: FunctionComponent<ScrollContainerProps> = ({
  ...
  return (
    <section className="col-12 bg-success scroll-container-fixed scroll-container-size">
      <h2 className="text-start">{category}</h2>
      <div className="col-12 overflow-x-scroll d-flex flex-row hstack gap-2 border border-secondary">
