...
const LandingPageScrollContainer: FunctionComponent<ScrollContainerProps> = ({
  ...
  return (
    <section className="col-9 bg-success scroll-container-fixed scroll-container-size">
      <h2 className="text-start">{category}</h2>
      <div className="col-9 overflow-x-scroll scroll-container-fixed d-flex flex-row hstack gap-2 border border-secondary">
