        ...
        .map((item, index) => (
          <div key={index} className="text-start vstack gap-3">
            ...
            <div className="justify-content-between d-flex flex-row flex-nowrap">
              <>
                {previous && (
                  <div className="d-flex flex-column vstack gap-1 bg-success">
                    <Button
              ...
              <>
                {next && (
                  <div className="d-flex flex-column vstack gap-1 bg-danger">
                    <Button
                    ...
                    <small className="text-end">{nextPage}</small>
                  </div>
                )}
              </>
            </div>
