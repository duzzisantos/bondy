...
const SideBar: FunctionComponent = () => {
  ...
  return (
    <div className="col-2 vh-100 custom-bg-color shadow-sm p-5 text-light d-flex flex-column vstack gap-5 sidebar-fixed">
      ...
      <div className="form-check form-switch justify-content-between bg-warning d-flex flex-row flex-nowrap">
        <Sun className="mx-auto mt-1" />
        <input
